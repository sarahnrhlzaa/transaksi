...
public class DetailTransaksi {
    ...
    // Convenience methods untuk akses langsung
    ...
    public void setKodeTransaksi(String kodeTransaksi) {
        if (id == null) {
            id = new DetailTransaksiId();
        }
        id.setKodeTransaksi(kodeTransaksi);
    }
    ...
    // ========================================================================
    // INNER CLASS: Composite Primary Key
    // ========================================================================
    @Embeddable
